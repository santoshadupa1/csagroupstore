...
public interface CSALocators {
    ...
    //Cart Locators
    // ✅ FIXED: Use contains() instead of [2] — [2] is hidden in headless/CI viewport
    public String CartLink = "(//a[contains(@class,'csa-cart-link')])[1]";
    ...
    // ✅ FIXED: Use parent element with flexible child matching
    public String ShippingCost = "//*[@id='shippingMethod']//div[contains(@class,'shipping') or @class or position()=2]";
    public String OrderView_ShippingCost = "//*[@id='orderShipping'] | //*[contains(@class,'shipping-cost')] | //*[@id='shippingMethod']//div[2]";
